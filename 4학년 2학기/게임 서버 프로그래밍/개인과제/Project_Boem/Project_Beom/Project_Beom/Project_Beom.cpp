                     ...
                     _In_ int       nCmdShow)
{
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_PROJECTBEOM));
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   hEdit = CreateWindowW(L"edit", NULL, WS_CHILD | WS_VISIBLE | WS_BORDER,
	   ...
	   controlsizeX, controlsizeY, g_NewhWnd, (HMENU)1, hInst, NULL);
   ...
   CreateWindowW(L"button", L"Connect", WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
	   ...
	   buttonsizeX, buttonsizeY, g_NewhWnd, (HMENU)2, hInst, NULL);
